"""PyQt6 Desktop GUI - Optional, only for local development.
Not required for Docker/Flask web app.
"""
...
try:
    ...
    print("PyQt6 not installed. Use: pip install -e '.[gui]'")
    sys.exit(1)
